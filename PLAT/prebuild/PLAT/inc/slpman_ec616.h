 ...
 * Description:  EC616 platform sleep management header file
...
#define PMU_DEFAULT_BL_TIME                     (9)

#if GD_FALSH
#define PMU_FLASH_WRITE_TIME_2SECTOR            (77)             // page write max time 2.4ms, 2 sector 76.8ms
...
typedef enum
{
	...
	DEEPSLP_TIMER_ID8 = 8,		// !! for EigenComm internal use only !!
	DEEPSLP_TIMER_ID9 = 9,		// !! for EigenComm internal use only !!
}slpManTimerID_e;
...
/**
  \fn          void slpManAONIORelease(void);
  \brief       release io latch
  \return      none.
*/
void slpManAONIORelease(void);
/**
