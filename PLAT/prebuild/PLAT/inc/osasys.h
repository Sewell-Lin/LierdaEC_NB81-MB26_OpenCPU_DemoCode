...
typedef enum OsaHibTimerId_enum
{
    ...
    PS_HIB_POWER_ON_DELAY_TIMER = 10,
...
#define OsaFreeMemory(pPtr)     OsaFreeMemoryV((void **)(pPtr), __FILE__, __LINE__)
#define OsaFreeMemoryNoCheck(pPtr)    OsaFreeMemoryV((void **)(pPtr), __FILE__, __LINE__)
