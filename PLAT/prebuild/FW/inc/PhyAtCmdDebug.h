...
typedef struct AtCmdPhyLogInfo_Tag
{
    UINT8  logLevel;   // 0: reduced Log level
                       // 1: all PHY log except with DEBUG_INFO level
                       // 2: all PHY log include DEBU_INFO level
}AtCmdPhyLogInfo;
...
void PhyRxTxDataDumpSet(UINT8 hwTask, UINT8 branchFlag);
