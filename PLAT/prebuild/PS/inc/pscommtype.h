 ...
 *****************************************************************************
******************************************************************************/
#define SUPPORT_MAX_BAND_NUM            16
#define RRC_PHY_SUPPORT_BAND_NUM        8       //this value is different from SUPPORT_MAX_BAND_NUM
...
typedef enum PlmnSearchPowerLevelTag
{
    ...
    */
    ...
    /*
     * OOS PLMN interval: 30 s, then stop PLMN search, and let AT: AT+ECPLMNS to start PLMN search
    */
