...
#if 0
typedef struct CmiMmSetCregModeReq_Tag
{
    UINT8 reportMode;   //CmiMmCregModeEnum
    UINT8 reserved1;
    UINT16 reserved2;
}CmiMmSetCregModeReq;

typedef CacCmiEmptySig CmiMmSetCregModeCnf;
#endif
...
typedef CacCmiEmptySig CmiMmGetCregReq;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetCregCapaReq;
 ...
 * AT+COPS=0
******************************************************************************/
typedef CacCmiEmptySig CmiMmSetAutoPlmnReq;

typedef CacCmiEmptySig CmiMmSetAutoPlmnCnf;
...
typedef struct CmiMmManualPlmnSelectReq_Tag
{
    ...
    UINT8 actPresent;
    UINT8 act;        // CmiCregActEnum, CMI_NB_IOT = 9 only

    CmiNumericPlmn plmn;
}CmiMmManualPlmnSelectReq;

typedef CacCmiEmptySig CmiMmManualPlmnSelectCnf;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmDeregisterReq;

typedef CacCmiEmptySig CmiMmDeregisterCnf;
...
typedef CacCmiEmptySig CmiMmSetOperIdFormatCnf;
 ...
 *  and <AcT> are omitted.
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetCurOperInfoReq;
...
typedef struct CmiMmGetCurOperInfoCnf_Tag
{
    ...
    UINT8   plmnFormat;   //CmiPlmnFormatEnum
    BOOL    uniPlmnPresent;
    UINT8   act;          //CmiCregActEnum, CMI_NB_IOT = 9 only, valid when "numPlmn" is valid
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmManualPlmnSearchReq;
...
typedef CacCmiEmptySig CmiMmSetPsmParmCnf;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetRequestedPsmParmReq;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetRequestedEdrxParmReq;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmReadEdrxDynParmReq;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetRequestedPtwEdrxParmReq;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetEmmTimeStateReq;
...
//typedef CacCmiEmptySig CmiMmSetCiotOptCfgCnf;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetCiotOptCfgReq;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetCiotOptCapaReq;
...
typedef struct CmiMmGetCiotOptCapaCnf_Tag
{
    ...
    UINT8 utOptBitmap;      //0000 1010, 0x0A
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetCEStatusReq;
...
#if 0
typedef struct CmiMmSnrChangeInd_Tag
{
    INT8    snr;
    UINT8   reserved0;
    UINT16  reserved1;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetCesqReq;
...
#if 0
typedef struct CmiMmSnrInd_Tag
{
    INT8    snr;
    UINT8   reserved1;
    UINT16  reserved2;
 ...
 * AT+ECPLMNS
******************************************************************************/
typedef CacCmiEmptySig CmiMmStartOosPlmnSelectReq;

typedef CacCmiEmptySig CmiMmStartOosPlmnSelectCnf;
...
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetPlmnSelectStateReq;
 ...
 * //^EMMTIMERI: <timerId>, <state>, [<timer period>, <bExceptionAllow>]
******************************************************************************/
 ...
 * +ECPSMR: <n>, <mode>
******************************************************************************/
typedef CacCmiEmptySig CmiMmGetPsmModeReq;
...
#define CMI_MM_SHORT_NW_NAME_LEN    8
