...
#define CMI_SIM_MAX_CMD_DATA_LEN       264
#define CMI_SIM_MAX_FILE_PATH_LEN      8
#define CMI_SIM_MAX_APDU_DATA_LEN      256
...
#define CMI_SIM_USAT_MAX_TP_LEN         36
...
typedef enum CMI_SIM_PRIM_ID_TAG
{
    ...
    CMI_SIM_GET_TERMINAL_PROFILE_REQ, /* at+cusatr= */
    CMI_SIM_GET_TERMINAL_PROFILE_CNF,
    CMI_SIM_WRITE_TERMINAL_PROFILE_REQ, /* at+cusatw= */
    CMI_SIM_WRITE_TERMINAL_PROFILE_CNF,
...
{
    CMI_SIM_PIN_VERIFY,       /* verify pin code */
...
//CMI_SIM_OPERATE_PIN_CNF
typedef CacCmiEmptySig CmiSimOperatePinCnf;
...
typedef struct CmiSimGenericAccessReqTag
{
    UINT16             reserved;
    UINT16             cmdReqLen;
    UINT8              cmdReqData[CMI_SIM_MAX_CMD_DATA_LEN];
}
...
typedef struct CmiSimGenericAccessCnfTag
{
    UINT16             reserved;
    UINT16             cmdRspLen;
    UINT8              cmdRspData[CMI_SIM_MAX_CMD_DATA_LEN];
}
...
typedef struct CmiSimRestrictedAccessReqTag
{
    ...
    UINT8                 p2;
    UINT8                 dataLen;
    UINT8                 data[CMI_SIM_MAX_APDU_DATA_LEN];
...
/*
* CMI_SIM_WRITE_TERMINAL_PROFILE_REQ
*/
typedef struct CmiSimUsatWriteTerminalProfileReqTag
{
        BOOL                resetDefaultTp;//reset the TP as default value
        UINT16              reserved;
        UINT8               tpLength;
        UINT8               tpData[CMI_SIM_USAT_MAX_TP_LEN];
}
CmiSimUsatWriteTerminalProfileReq;

/*
* CMI_SIM_WRITE_TERMINAL_PROFILE_CNF
*/
typedef CacCmiEmptySig CmiSimUsatWriteTerminalProfileCnf;
