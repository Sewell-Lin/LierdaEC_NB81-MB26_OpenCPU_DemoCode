...
#define CMI_PS_MIN_VALID_CID        1
#define CMI_PS_INVALID_CID          0
#define CMI_PS_MAX_TFT_FILTERS      16
#define CMI_PS_MAX_APN_LEN          100
#define CMI_PS_MAX_AUTH_STR_LEN     20
...
typedef enum CMI_PS_PRIM_ID_TAG
{
    ...
    */
    ...
    CMI_PS_NO_MORE_PS_DATA_REQ,     //AT+CNMPSD, -TBD
...
*/
typedef CacCmiEmptySig CmiPsDefineBearerCtxCnf;
...
*/
typedef CacCmiEmptySig  CmiPsSetBearerActStateCnf;
...
{
    UINT8       cid;        //1-15
    UINT8       epsId;      //1-15, if not activated, set to 0
    UINT8       bearerState;    //CmiPsBearerState
    UINT8       bearerType;     //CmiPsBearerType
