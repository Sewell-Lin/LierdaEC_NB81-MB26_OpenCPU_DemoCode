...
#define NM_PS_CID_MIN               1
#define NM_PS_CID_MAX               15
#define NM_PS_INVALID_CID           0
 ...
 * Comment:
******************************************************************************/
NmResult NetMgrPingRequest(ip_addr_t *pDest, UINT8 count, UINT16 payloadLen, UINT32 timeout, UINT16 reqHandle);
 ...
 * Comment:
******************************************************************************/
NmResult NetMgrPingUrlRequest(const CHAR* pingTarget, UINT8 count, UINT16 payloadLen, UINT32 timeout, UINT16 reqHandle);
