...
typedef enum CMI_DEV_PRIM_ID_TAG
{
    ...
    CMI_DEV_GET_EXT_STATUS_REQ,     //CmiDevGetExtStatusReq, AT+ECSTATUS / AT+ECSTATUS?
 ...
 * AT+ECBAND=<mode>,<band1>,<band2>,<band3>...
******************************************************************************/
...
#define CMI_DEV_SUPPORT_MAX_BAND_NUM 16
 ...
 * AT+ECCFG="GCFTEST", 0/1, "AUTOAPN", 0/1, "SUPPORTSMS", 0/1, "SIMTEST", 0/1..
******************************************************************************/
...
typedef struct CmiDevGetExtCfgCnf_Tag
{
    ...
    BOOL    enableSimPsm;           //+NCONFIG:NAS_SIM_POWER_SAVING_ENABLE, XX
...
/******************************************************************************
 * CMI_DEV_GET_EXT_STATUS_REQ, //AT+ECSTATUS?
...
typedef struct CmiDevL2StatusInfo_Tag
{
    ...
    UINT8       rlcUlBler;           //RLC layer block error rate (uplink). Integer %
    UINT8       rlcDlBler;           //RLC layer block error rate (downlink). Integer %
...
typedef struct CmiDevGetBasicCellListInfoCnf_Tag
{
    ...
    CmiDevSCellBasicInfo    sCellInfo;  //20 bytse
    CmiDevNCellBasicInfo    nCellList[CMI_DEV_NCELL_INFO_CELL_NUM]; //48 bytes
}CmiDevGetBasicCellListInfoCnf; //72 bytes
...
typedef struct CmiDevGetExtStatusCnf_Tag
{
    ...
    CmiDevGetBasicCellListInfoCnf   basicCellListInfo;
}CmiDevGetExtStatusCnf; //160 bytes
...
******************************************************************************/
typedef struct CmiDevSetEcpstestReq_Tag
{
    BOOL    enablePsTest;
    UINT8   reserved0;
    UINT16  reserved1;
}
CmiDevSetEcpstestReq;

typedef CacCmiEmptySig CmiDevSetEcpstestCnf;

/******************************************************************************
 * CMI_DEV_GET_ECPSTEST_REQ
******************************************************************************/
typedef CacCmiEmptySig CmiDevGetEcpstestReq;

typedef struct CmiDevGetEcpstestCnf_Tag
{
    BOOL    enablePsTest;
    UINT8   reserved1;
    UINT16  reserved2;
}
CmiDevGetEcpstestCnf;
