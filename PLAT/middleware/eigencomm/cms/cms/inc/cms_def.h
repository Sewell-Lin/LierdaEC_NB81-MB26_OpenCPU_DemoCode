...
/******************************************************************************
 * 3 bits SUB AT ID, value: 0 - 8
 * 1> 0 is default value
 * 2> 0 - 5, used for EC
 * 3> 6,7,8, used for REF
******************************************************************************/
/*
...
#define CMS_EC_MAX_SUB_AT_ID        5

/*
 * SUB AT ID, used for REF AT CMD
*/
#define CMS_REF_SUB_AT_1_ID         6
#define CMS_REF_SUB_AT_2_ID         7
#define CMS_REF_SUB_AT_3_ID         8
