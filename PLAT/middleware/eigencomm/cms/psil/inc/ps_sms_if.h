...
#define PSIL_MSG_VP_DEFAULT             ((UINT8)167)        /* 24 hours - see 3GPP TS 23.040 */
#define PSIL_MSG_PID_DEFAULT            ((UINT8)0)          /* see 3GPP TS 23.040 */
...
typedef enum PsilSmsDCSClass_enum
{
    ...
    PSIL_SMS_DCS_CLASS_1,
    PSIL_SMS_DCS_CLASS_2,
    PSIL_SMS_DCS_CLASS_3
}PsilSmsDCSClass;

typedef enum PsilSmsDCSIndType_Tag
{
    PSIL_SMS_DCS_VOICEMAIL_IND = 0,
    PSIL_SMS_DCS_FAX_IND,
    PSIL_SMS_DCS_EMAIL_IND,
    PSIL_SMS_DCS_OTHER_IND
}PsilSmsDCSIndType;
