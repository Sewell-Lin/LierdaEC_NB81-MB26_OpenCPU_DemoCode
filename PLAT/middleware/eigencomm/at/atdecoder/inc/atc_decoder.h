...
typedef enum AtCmdReqType_enum
{
    ...
    AT_EXEC_REQ         = 1,        //AT+CMD1, no parameter
...
typedef enum AtValueType_enum
{
    ...
    AT_MIX_VAL,     /*input parameters, could be "numeric" or "string", AT decoder try to decode according to the input value */
...
typedef enum AtcState_enum
{
    ...
    */
     ...
     * 4> ATEC SMS parser the input, and when meet: ctrl-z/ESC, then change the "atcState" to : ATC_ONLINE_CMD_STATE, and send/cancel this SMS
    */
