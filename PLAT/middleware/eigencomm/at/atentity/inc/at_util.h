 ...
 *****************************************************************************
******************************************************************************/
typedef struct atCmdReqParaTag
{
    UINT32  decMin;     //used for dec param
    UINT32  decMax;     //used for dec param
    UINT32  decDef;     //default value used for dec param

    UINT16  maxStrBufSize;  //used for str param
    UINT16  strLenReal;     //out value, used for str param
    CHAR    *strDef;        //default str used for str param

    //INT32   defaultFlag;    //out value, used for str and dec param
}atCmdParaCheck;
