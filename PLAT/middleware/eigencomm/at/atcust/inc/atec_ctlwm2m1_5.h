...
#define MAX_PSKID_LEN         (64)
#define MAX_PSK_LEN           (64)
#define MIN_LIFETIME_VAL      (300)
#define DEFAULT_LIFE_TIME     (300)
...
CmsRetId  ctm2mNOTIFY(const AtCmdInputContext *pAtCmdReq);
