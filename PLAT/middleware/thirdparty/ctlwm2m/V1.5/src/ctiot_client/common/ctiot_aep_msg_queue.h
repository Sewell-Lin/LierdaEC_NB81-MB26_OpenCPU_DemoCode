...
int8_t ctiot_funcv1_coap_queue_add(ctiot_funcv1_msg_list_head* list, void* ptr);
...
int8_t ctiot_funcv1_coap_queue_remove(ctiot_funcv1_msg_list_head* list, uint16_t msgid, void *ptr);
int8_t ctiot_funcv1_coap_queue_free(ctiot_funcv1_msg_list_head** list);
