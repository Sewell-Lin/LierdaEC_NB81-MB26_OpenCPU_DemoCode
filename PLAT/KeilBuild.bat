...
echo BOARD_NAME: %PARAMETERS% | findstr "ec617_0h00"
if not errorlevel 1 (
  set BOARD_NAME=ec617_0h00
  set CHIP_NAME=ec617
)
...
echo PROJECT_NAME: %PARAMETERS% | findstr "aliyun_example"
if not errorlevel 1 (
  set PROJECT_NAME=aliyun_example
)

echo PROJECT_NAME: %PARAMETERS% | findstr "cucc_autoreg_example"
if not errorlevel 1 (
  set PROJECT_NAME=cucc_autoreg_example
)
...
echo PROJECT_NAME: %PARAMETERS% | findstr "flash_example"
if not errorlevel 1 (
  set PROJECT_NAME=flash_example
)
...
echo PROJECT_NAME: %PARAMETERS% | findstr "fs_example_inter"
if not errorlevel 1 (
  set PROJECT_NAME=fs_example_inter
)

echo PROJECT_NAME: %PARAMETERS% | findstr "nvram_testcase"
if not errorlevel 1 (
  set PROJECT_NAME=nvram_testcase
)
...
echo PROJECT_NAME: %PARAMETERS% | findstr "cisdm_example"
if not errorlevel 1 (
  set PROJECT_NAME=cisdm_example
)
...
echo PROJECT_NAME: %PARAMETERS% | findstr "abupfota_example"
if not errorlevel 1 (
  set PROJECT_NAME=abupfota_example
)
...
echo PROJECT_NAME: %PARAMETERS% | findstr "lierdaEC_lib"
if not errorlevel 1 (
  set PROJECT_NAME=lierdaEC_lib
)
