...
#define RTE_UART2_TX_IO_MODE    POLLING_MODE    // USART supports polling/interrupt/dma mode 
#define RTE_UART2_RX_IO_MODE    DMA_MODE

#define RTE_SPI0_IO_MODE        POLLING_MODE  // SPI supports polling/interrupt/dma mode 

// #define RTE_SPI1_IO_MODE        POLLING_MODE

#define I2C0_INIT_MODE          POLLING_MODE   // I2C currently only supports POLLING mode
